...
export const socialNetworks: SocialNetwork[] = [
  ...
  { name: 'Reddit', icon: 'reddit', tone: '#FF4500', link: 'https://www.reddit.com/user/' },
  { name: 'StackOverflow', icon: 'stackoverflow', tone: '#F58025', link: 'https://stackoverflow.com/users/', noAt: true },
  { name: 'KeyBase', icon: 'keybase', tone: '#33A0FF', link: 'https://keybase.io/', noAt: true },
  { name: 'Facebook', icon: 'facebook', tone: '#1877F2', link: 'https://www.facebook.com/' },
  { name: 'PeerList', icon: 'peerlist', tone: '#00ac43', link: 'https://peerlist.io/' },
  { name: 'CodersRank', icon: 'codersrank', tone: '#72a0a8', link: 'https://profile.codersrank.io/user/' },
  { name: 'OMG.lol', icon: 'omg-lol', tone: '#ff69ad', link: 'https://omg.lol/' },
];
